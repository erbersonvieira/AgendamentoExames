...
public class FrmCandidato extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulário Candidato");
...
//        c.setIdCandidato = c.getIdCandidato()+1;
        c.setNomeCandidato(jTextField1.getText());
        c.setCpfCandidato(jTextField2.getText());
        if (jComboBox1.getSelectedIndex()==0){
           c.setSexoCandidato("Masculino");
        }else{
         c.setSexoCandidato("Feminino");   
        }
    
        

       valor = f.inserirCandidato(c);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i=0;i < list.size() ; i++){
         modelo.addRow(new Object[] {list.get(i).getIdCandidato(), list.get(i).getNomeCandidato(), 
                                     list.get(i).getCpfCandidato(), list.get(i).getSexoCandidato()});
        }
    }                                        
     public void tabela(){
